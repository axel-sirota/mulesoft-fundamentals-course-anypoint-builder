...
### HTML Notebooks
Each module directory contains **two** HTML files:
- `module-{NN}.html` — Instructor version (source of truth, includes `<details class="instructor-note">` blocks)
- `module-{NN}-student.html` — Student version (auto-generated, instructor notes stripped)

The student version is generated by `shared/scripts/generate-student-html.py`. Never edit it directly.
