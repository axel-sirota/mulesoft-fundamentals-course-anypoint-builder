...
if __name__ == "__main__":
    ...
    print("=" * 50)
    print(f"  GET  http://localhost:5173/api/customers")
    print(f"  GET  http://localhost:5173/api/customers/ACCT-001")
    print(f"  GET  http://localhost:5173/api/customers?industry=Technology")
    print(f"  POST http://localhost:5173/api/customers/import")
    print("=" * 50 + "\n")
